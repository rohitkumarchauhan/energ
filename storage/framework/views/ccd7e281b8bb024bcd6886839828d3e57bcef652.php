                    ...
                    <form class="form-horizontal" method="post" action="<?php echo e(route('users.update',$user->id)); ?>"
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" id="fname" placeholder="" value="<?php echo e(isset($user->name) ? $user->name : ''); ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email</label>
                                <div class="col-sm-9">
                                    <input type="email" name="email" class="form-control" id="lname" placeholder="" value="<?php echo e(isset($user->email) ? $user->email : ''); ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9">
                                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(($key==$user->role_id)?'selected':''); ?> ><?php echo e($val); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="img-container has-image-container" style="<?php if(empty($user->profileImage)): ?> display: none <?php endif; ?>">
                                        <img id="image" src="<?php echo e(asset('images/thumbnail/profile').'/thumb-'.$user->profileImage); ?>" alt="Picture">
                                    </div>
                                </div>
                            </div>
