            ...
            <div class="col-md-12">
                <div class="card col-md-12">
                    <form class="form-horizontal garment_form_outer" method="post"
                          action="<?php echo e(route('pages.update',$page->id)); ?>"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="title" class="form-control" placeholder="" value="<?php echo e($page->title); ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="col-md-5">
                                    <select class="form-control" name="type_id" required>
                                        <?php $__currentLoopData = $page->getType(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php if($page->type_id==$key): ?> selected <?php endif; ?>><?php echo e($val); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" class="form-control" id="editor" required><?php echo e($page->description); ?></textarea>
                                </div>
                            </div>
