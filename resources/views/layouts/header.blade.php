                ...
                <div class="join-user">
                    @if(empty(auth()->user()->id))
                        <div class="join-login">
                            <a href="{{route('register')}}"><span class="color-red"><i class="fa fa-user" aria-hidden="true"></i></span>Join</a>
                            <a href="{{route('login')}}"><span class="color-green"><i class="fa fa-sign-in" aria-hidden="true"></i></span>Login</a>
                        </div>
                    @else
                        <div class="user-logout">
                            <img src="images/user.png" class="img-responsive"> <span class="user-nm">{{ auth()->user()->name }} {{ auth()->user()->lastname }}</span>
                            <a href="{{route('logout')}}"><span class="color-green"><i class="fa fa-sign-out" aria-hidden="true"></i></span>Logout</a>
                        </div>
                    @endif
                </div>
