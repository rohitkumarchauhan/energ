                    ...
                    <form class="form-horizontal garment_form_outer" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="title" class="form-control" placeholder="" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" class="form-control" id="editor" required>{{ old('description') }}</textarea>
                                </div>
                            </div>
