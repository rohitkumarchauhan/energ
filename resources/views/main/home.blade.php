...
<!-- /.Slider End -->
        ...
        <div class="container">
            <div class="row">
                <div class="about-contant theme-contant">
                    ...
                    <div class="col-sm-6">
                        <img src="{{asset('images/about-us.jpg')}}" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog-sec">
        ...
        <div class="blog-contant">
            <div class="container">
                <div class="row">
                    <div class="owl-carousel owl-carousel-second">
                        <div class="item">
                            <div class="blog-cover">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <img src="{{asset('images/blog.jpg')}}" class="img-responsive" class="img-responsive">
                                    </div>
                                    <div class="col-xs-6">
                                        <div class="blog-post">
                                            <div class="header"><a href="#"><img src="{{asset('images/user.png')}}" class="img-responsive"><span>John Doe </span></a><span> 26th April, 2018</span></div>
    ...
    <section class="update-sec">
        ...
        <div class="update-contant">
            <div class="container">
                <div class="row">
                    <div class="owl-carousel owl-carousel-third">
                        <div class="item">
                            <div class="blog-cover">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img src="{{asset('images/update-sec.jpg')}}" class="img-responsive">
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="blog-post">
                                                    <div class="blog-img"><img src="{{asset('images/blog-post.jpg')}}" class="img-responsive"> </div>
                    ...
                    <div class="owl-carousel owl-carousel-fourth">
                        <div class="item">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('images/testemonial.jpg')}}" class="img-responsive">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <img src="{{asset('images/testemonial1.jpg')}}" class="img-responsive">
                                </div>
...
@section('scripts')
    <script>
        ...
        var owl_third = $('.owl-carousel-third');
        ...
        var owl_fourth = $('.owl-carousel-fourth');
